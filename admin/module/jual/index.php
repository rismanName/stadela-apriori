						...
						<table class="table table-stripped">
                                                        ...
                                                        if($isNotaYes && $_SERVER['REQUEST_METHOD'] === 'POST') {
                                                                ...
                                                                if($bayar > 0.0) {
                                                                        ...
                                                                        if($bayar >= $total) {
                                                                                ...
                                                                                $idMemberList = filter_input(INPUT_POST, 'id_user', FILTER_DEFAULT, ['flags' => FILTER_REQUIRE_ARRAY]);
                                                                                ...
                                                                                for($x = 0; $x < $jumlahDipilih; $x++) {
                                                                                        ...
                                                                                        $sql = "INSERT INTO nota (id_barang,id_user,jumlah,total,tanggal_input,periode) VALUES(?,?,?,?,?,?)";
							...
							<!-- aksi ke table nota -->
								...
								<?php foreach($hasil_penjualan as $isi){;?>
									...
									<input type="hidden" name="id_user[]" value="<?= htmlspecialchars($isi['id_user'], ENT_QUOTES, 'UTF-8');?>">
							...
							<tr>
								...
								<td></td>
								<td>
                                                                        <a href="print.php?nama=<?php echo urlencode($_SESSION['user']['nama']);?>
